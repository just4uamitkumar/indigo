            ...
            <section className="greyBox">
                <div className="container">
                    ...
                    <div className="tabLiks">
                        <ul>
                            <li>
                                <button className={showFirst ? 'active' : ''} onClick={firstTab}>
                                    Features
                                </button>
                            </li>
                            <li>
                                <button className={showSecond ? 'active' : ''} onClick={secondTab}>
                                    Festive Offers
                                </button>
                            </li>
                            <li>
                                <button className={showThird ? 'active' : ''} onClick={thirdTab}>
                                    Steps to get a Card
                                </button>
                            </li>
                        </ul>
            ...
            <div className="pageContent">
                <div className="container">
                    ...
                    <div className={showThird ? 'tabItem active' : 'tabItem'}>
                        ...
                        <p>Earlier in this tutorial we made a web page with rows and columns, 
                            ...
                            design behave differently on each side of the breakpoint.</p>
